...
`;
    ...
    class ExternalForce extends ShaderPass {
      mouse!: THREE.Mesh;
      constructor(simProps: Partial<SimProps>) {
        super({ output: simProps.dst });
        this.initForce(simProps);
      }
      initForce(simProps: Partial<SimProps>) {
        super.init();
      ...
      update(...args: unknown[]) {
        const props = (args[0] || {}) as Partial<SimProps>;
    ...
    class Viscous extends ShaderPass {
      constructor(simProps: SimProps) {
        super({
          ...
          output: simProps.dst || null,
          output0: simProps.dst_ || undefined,
          output1: simProps.dst || undefined
        });
        this.init();
      }
      update(...args: unknown[]) {
    ...
    class Poisson extends ShaderPass {
      ...
      update(...args: unknown[]) {
        ...
        let p_in: THREE.WebGLRenderTarget | undefined, p_out: THREE.WebGLRenderTarget | undefined;
        const iter = iterations ?? 0;
        for (let i = 0; i < iter; i++) {
          if (i % 2 === 0) {
    ...
    class Simulation {
      ...
      update() {
        ...
        let vel: THREE.WebGLRenderTarget | undefined = this.fbos.vel_1 || undefined;
        ...
        const pressure = this.poisson.update({ iterations: this.options.iterations_poisson }) as THREE.WebGLRenderTarget | undefined;
